...
CpatternDoc::CpatternDoc() noexcept
{
...
void CpatternDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CpatternDoc::InitializeSearchContent()
{
...
void CpatternDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
